...
export function initPipeline() {
    ...
    constant.pipelineView.selectAll("image")
        ...
        .on("mouseover", function (d, i) {
            if (d.type == constant.PIPELINE_ADD_STAGE || d.type == constant.PIPELINE_END) {
                d3.select("#" + d.id)
                    .attr("xlink:href", function (d, i) {
                ...
                var editBtnShow = false,addActionBtnShow = false, deleteBtnShow = false;                                      
                    /**
                            ...
                            */ 
                             constant.buttonView.select("#button-group")
                                ...
                                .on("click", function(dd, di){
                                    ...
                                    var relatedActions = util.findAllActionsOfStage(d.id)
