...
exports.bipatiteLine = bipatiteLine;

var _setPath = require("./setPath");

function bipatiteLine(array) {
...
function settingOut(point) {
	...
	d3.select("#bipatiteLineSvg").append("path").attr("d", d).attr("stroke", "green").attr("stroke-width", 1).attr("fill", "none").attr("stroke-opacity", "0.2");
}